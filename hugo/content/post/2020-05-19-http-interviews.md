...
categories: [ Tech ]
URL: "/2020/05/19/http-interviews/"
...
![http-content](https://image.my-blog.wang/2020-05-19-http-interviews/http-content.png)
...
![tcp-five](https://image.my-blog.wang/2020-05-19-http-interviews/tcp-five.png)

但是也可以分为四层，就是**把链路层和物理层都表示为网络接口层**

![tcp-four](https://image.my-blog.wang/2020-05-19-http-interviews/tcp-four.png)

还有一种就是 OSI 七层网络模型，它就是在五层协议之上加了**表示层和会话层**

![osi-seven](https://image.my-blog.wang/2020-05-19-http-interviews/osi-seven.png)
...
![http-https-content](https://image.my-blog.wang/2020-05-19-http-interviews/http-https-content.png)
...
![chrome-ssl](https://image.my-blog.wang/2020-05-19-http-interviews/chrome-ssl.png)
...
![chrome-cookies-set](https://image.my-blog.wang/2020-05-19-http-interviews/chrome-cookies-set.png)
...
![cookies-procedure](https://image.my-blog.wang/2020-05-19-http-interviews/cookies-procedure.png)
...
![cookies-session](https://image.my-blog.wang/2020-05-19-http-interviews/cookies-session.png)
...
![tcp-vs-udp](https://image.my-blog.wang/2020-05-19-http-interviews/tcp-vs-udp.png)

下面为你罗列了一些 TCP 和 UDP 的不同点，方便理解，方便记忆。

![tcp-vs-udp2](https://image.my-blog.wang/2020-05-19-http-interviews/tcp-vs-udp2.png)
...
![tcp-signals](https://image.my-blog.wang/2020-05-19-http-interviews/tcp-signals.png)
...
![tcp-three-hand](https://image.my-blog.wang/2020-05-19-http-interviews/tcp-three-hand.png)
...
![tcp-four-hand](https://image.my-blog.wang/2020-05-19-http-interviews/tcp-four-hand.png)
...
![http1.1-vs-http2](https://image.my-blog.wang/2020-05-19-http-interviews/http1-vs-http2.png)
...
![timezone-transform](https://image.my-blog.wang/2020-05-19-http-interviews/timezone-transform.png)
...
![http1-1-head-content](https://image.my-blog.wang/2020-05-19-http-interviews/http1-1-head-content.png)
...
![entity-header-column](https://image.my-blog.wang/2020-05-19-http-interviews/entity-header-column.png)
...
![http1-1-request-header](https://image.my-blog.wang/2020-05-19-http-interviews/http1-1-request-header.png)
...
![http1-1-response-header](https://image.my-blog.wang/2020-05-19-http-interviews/http1-1-response-header.png)
...
![chrome-search](https://image.my-blog.wang/2020-05-19-http-interviews/chrome-search.png)
...
>
> <img src="https://image.my-blog.wang/2020-05-19-http-interviews/dns1.png" alt="dns1" style="zoom:50%;" />

DNS 是一种分层数据库，它的主要层次结构如下

![dns2](https://image.my-blog.wang/2020-05-19-http-interviews/dns2.png)
...
![https-compose](https://image.my-blog.wang/2020-05-19-http-interviews/https-compose.png)
...
![tls-procedure](https://image.my-blog.wang/2020-05-19-http-interviews/tls-procedure.png)
